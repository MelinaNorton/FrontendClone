...
const LocationsSection = () => {
    ...
    return(
        <main className="bg-black bg-cover h-min-screen flex flex-col lg:gap-y-10 gap-y-10 justify-start items-center relative overflow-x-clip font-sans p-5">
            <div className="flex lg:flex-col 2xl:flex-col md:flex-row flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 2xl:w-4/10 lg:w-67/70 w-95">
                <h1 className="lg:pr-10 lg:text-4xl text-xl font-bold 2xl:pr-10 pr-12 2xl:pb-2 lg:pb-2 pb-0">Our Locations</h1>
            ...
            <div className="flex lg:flex-row 2xl:flex-col md:flex-row flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 2xl:w-4/10 lg:w-69/70 w-95 2xl:pt-15 lg:pt-15 pt-0">
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex justify-start items-start 2xl:pl-0 lg:pl-2 pl-118">
                    ...
                    <div className="flex flex-col 2xl:gap-4 lg:gap-2 gap-2 2xl:pl-0 lg:pl-0 pl-10">
                        <div className="flex flex-row lg:justify-center 2xl:justify-center justify-start 2xl:gap-x-4 lg:gap-x-2 gap-x-4">
