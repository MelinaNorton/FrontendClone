...
const LocationsSection = () => {
    ...
    return(
        <main className="bg-black bg-cover h-min-screen flex flex-col lg:gap-y-10 gap-y-10 justify-start items-center relative overflow-x-clip font-sans p-4">
            <div className="flex md:flex-col flex-col gap-y-2 gap-x-20 lg:gap-x-10 w-full 2xl:w-[40vw]">
            ...
            <div className="flex flex-row justify-center items-center gap-x-8 w-screen lg:w-full">
            ...
            <div className="flex lg:flex-row 2xl:flex-col md:flex-col flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 w-full 2xl:w-[40vw]">
                ...
                <div className="flex flex-col gap-3 justify-center items-start w-full 2xl:justify-center 2xl:items-center">
                    ...
                    <div className="flex flex-col 2xl:gap-4 2 gap-2">
                        ...
                        <div className="flex-row justify-center 2xl:gap-x-4 gap-x-2 2xl:flex lg:flex hidden">
                ...
                <div className="flex flex-col gap-3 justify-center items-start w-full 2xl:items-center">
                    ...
                    <div className="flex flex-col lg:flex-row 2xl:gap-4 2 gap-2 max-w-none w-max">
