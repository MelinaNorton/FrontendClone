...
const LocationsSection = () => {
    ...
    return(
        <main className="bg-black bg-cover h-min-screen flex flex-col lg:gap-y-10 gap-y-10 justify-start items-center relative overflow-x-clip font-sans p-4">
            ...
            <div className="flex lg:flex-row 2xl:flex-col md:flex-col flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 w-full">
                ...
                <div className="flex flex-col gap-3 border border-red-500 justify-center items-start w-full">
                ...
                <div className="flex flex-col gap-3 border border-red-500 justify-center items-start w-full">
                    <div className="flex flex-row justify-start 2xl:gap-86 lg:gap-70 gap-80">
