...
const ClientImage:React.FC<clientProps> = (props:clientProps) =>{
    ...
    return(
        <div className="relative flex flex-col items-center justify-center 2xl:h-25 lg:h-25 h-23 2xl:w-53 lg:w-50 w-50 hover:scale-102 transition-all duration-500 hover:cursor-pointer">
