const ApplyMeet = () => {
    return(
        <main className="bg-black 2xl:bg-[url('/resources/ApplyMeet.png')] lg:bg-[url('/resources/ApplyMeet.png')] bg-cover lg:h-screen h-[50vh] flex flex-col justify-center items-center relative overflow-x-clip font-sans w-screen">
