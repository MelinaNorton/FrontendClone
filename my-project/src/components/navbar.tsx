        ...
        <main>
            <div className="flex flex-col bg-gray-300/13 backdrop-blur-sm lg:h-25 md:h-17 2xl:h-25 h-18 w-screen fixed z-40 justify-center items-center">
                    <img src = "/resources/Rainbow_Accent.png" className="absolute top-0 w-full z-0"></img>
                        <div className= "flex flex-row items-center justify-between lg:justify-between lg:pr-6 2xl:w-[40vw] w-full">
                            ...
                            <button className="hidden lg:flex text-white bg-gradient-to-r from-gray-600/50 to-gray-700/50 hover:bg-gray-600/50 rounded-4xl lg:text-lg font-extralight hover:cursor-pointer px-6 py-2" onClick={ ()=> router.push('./application')}>JOIN US, BE BOLD!</button>
                            </div>
                </div>
        </main>
    );
