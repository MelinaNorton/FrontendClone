...
const ServiceSection = () => {
    return (
        <main className="bg-black bg-cover flex flex-col lg:gap-y-10 2xl:gap-y-15 gap-y-15 justify-start items-center relative overflow-x-clip font-sans 2xl:pb-10 lg:pb-10 pb-0">
            <div className="flex lg:flex-row 2xl:flex-col md:flex-col flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 2xl:w-4/10 lg:w-66/70 md:w-66/70 w-95">
                <h1 className="lg:pr-8 lg:text-4xl md:text-3xl text-xl font-bold 2xl:pr-10 pr-10 lg:whitespace-nowrap">Our Services</h1>
            ...
            <div className="flex flex-row 2xl:justify-center lg:justify-center justify-start 2xl:pl-0 lg:pl-0 md:pl-120 pl-218 lg:gap-x-8 2xl:gap-x-8 gap-x-0 2xl:pb-15 lg:pb-15 pb-0">
            ...
            <div className="flex lg:flex-row md:flex-col flex-col gap-x-30 2xl:w-4/10 lg:w-66/70 md:w-65/70 w-95">
                <h1 className="lg:pr-10 lg:text-4xl md:text-3xl text-xl font-bold 2xl:pr-10 pr-10">Industries</h1>
            ...
            <div className="flex flex-row lg:justify-start 2xl:justify-center justify-start gap-x-5 2xl:pl-0 lg:pl-0 md:pl-55 pl-150 2xl:pb-15 lg:pb-15 pb-0">
            ...
            <div className="flex flex-col gap-y-3 justify-start items-center 2xl:w-4/10 lg:w-69/70 md:w-65/70 w-90">
                <div className="flex lg:flex-row 2xl:flex-row md:flex-col flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 lg:w-67/70 md:w-70/70 w-95">
                    <h1 className="lg:pr-10 lg:text-4xl md:text-3xl text-xl font-bold 2xl:pr-10 pr-10 2xl:whitespace-nowrap flex auto lg:basis-2/5">Industry Certification & Compliance</h1>
                ...
                <div className="flex flex-row lg:justify-center 2xl:justify-center justify-start items-start lg:gap-x-8 2xl:gap-x-8 gap-x-3 2xl:pl-0 lg:pl-0 md:pl-65 pl-75">
