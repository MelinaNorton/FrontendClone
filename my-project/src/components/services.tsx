...
const ServiceSection = () => {
    return (
        <main className="bg-black bg-cover flex flex-col lg:gap-y-10 2xl:gap-y-15 gap-y-15 justify-start items-start relative overflow-x-clip font-sans pl-4 pr-4 2xl:pl-8 2xl:pr-8">
            <div className="flex lg:flex-row 2xl:flex-col md:flex-col flex-col w-funn">
            ...
            <div className="flex flex-row justify-start lg:justify-between lg:items-center items-start max-w-none border border-red-500 lg:w-full overflow-clip space-x-8 ">
            ...
            <div className="flex lg:flex-row md:flex-col flex-col gap-x-30 w-full lg:pl-8 lg:pr-8 pl-4 pr-4">
            ...
            <div className="flex flex-col gap-y-3 justify-start items-start w-full">
                <div className="flex lg:flex-row 2xl:flex-row md:flex-col flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 w-full">
                ...
                <div className="flex flex-row justify-between items-start w-screen lg:w-full overflow-clip gap-x-6">
