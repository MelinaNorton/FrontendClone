...
const ServiceSection = () => {
    return (
        <main className="bg-black bg-cover flex flex-col lg:gap-y-10 2xl:gap-y-15 gap-y-10 justify-start items-center relative overflow-x-clip font-sans">
            ...
            <div className="flex flex-row 2xl:justify-center lg:justify-center justify-start 2xl:pl-0 lg:pl-0 pl-218 lg:gap-x-8 2xl:gap-x-8 gap-x-0">
            ...
            <div className="flex lg:flex-row md:flex-row flex-col gap-x-30 2xl:w-4/10 lg:w-69/70 w-95">
            ...
            <div className="flex flex-row lg:justify-start 2xl:justify-center justify-start gap-x-5 2xl:pl-0 lg:pl-0 pl-148">
            ...
            <div className="flex flex-col gap-y-3 justify-start items-center 2xl:w-4/10 lg:w-69/70 w-90">
                <div className="flex lg:flex-row 2xl:flex-row md:flex-row flex-col gap-y-2 gap-x-20 lg:gap-x-10 2xl:gap-x-20 lg:w-69/70 w-95">
