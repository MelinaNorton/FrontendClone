...
const SubsidiariesSection = () => {
    ...
    return(
        <main className="bg-black bg-cover h-min-screen flex flex-col lg:gap-y-10 gap-y-4 justify-start items-center relative overflow-x-clip font-sans p-4 w-screen">
            ...
            <div className="flex flex-row justify-start lg:justify-between lg:items-center items-start max-w-none border border-red-500 lg:w-full space-x-8 w-full">
                ...
                <div className="flex flex-col gap-3 items-start justify-center w-full border border-red-500">
