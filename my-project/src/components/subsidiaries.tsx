            ...
            <div className="flex flex-row items-start justify-center 2xl:w-10/15 lg:w-300 w-95 2xl:pt-8 lg:pt-8 pt-0">
                <div className="flex flex-col gap-3 2xl:w-9/15 items-start justify-center lg:w-300 w-95">
                    ...
                    <div className="flex flex-row 2xl:w-11/19 lg:w-11/19 w-100 items-start gap-3">
                        <button className=" text-white bg-gradient-to-r flex from-gray-600/50 to-gray-700/50 hover:bg-gray-600/50 hover:border-white rounded-4xl text-xs lg:text-lg font-extralight px-4 sm:px-6 py-3 sm:py-2 border-1 border-background">BLOGS</button>
                        <button className=" text-white bg-gradient-to-r flex from-gray-600/50 to-gray-700/50 hover:bg-gray-600/50 hover:border-white rounded-4xl text-xs lg:whitespace-normal 2xl:whitespace-normal whitespace-nowrap lg:text-lg font-extralight px-4 sm:px-6 py-3 sm:py-2 border-1 border-background">CASE STUDIES</button>
                        <button className=" text-white bg-gradient-to-r flex from-gray-600/50 to-gray-700/50 hover:bg-gray-600/50 hover:border-white rounded-4xl text-xs lg:whitespace-normal 2xl:whitespace-normal whitespace-nowrap lg:text-lg font-extralight px-4 sm:px-6 py-3 sm:py-2 border-1 border-background">WHITE PAPERS</button>
                    </div>
                </div>
            </div>
