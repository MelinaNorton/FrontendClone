...
const ICCImage:React.FC<ICCProps> = (props : ICCProps) =>{
    return (
        <div className="relative flex flex-col items-center justify-center lg:h-23 2xl:h-24 h-23 2xl:w-50 lg:w-70 w-40 transform-all hover:scale-102 duration-500 hover:cursor-pointer">
