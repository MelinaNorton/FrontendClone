...
const OpenPosition:React.FC<openPosProps> = (props:openPosProps) => {
    ...
    return(
        <div className="group">
            <div className="bg-gray-300/20 w-90 lg:w-95 h-15 flex flex-row justify-end items-center rounded-lg group-hover:bg-gray-400/80 p-4 group-hover:cursor-pointer" onClick={props.onClick}>
