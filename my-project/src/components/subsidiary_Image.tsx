...
const SubsidiaryImage:React.FC<imgProps> = (props : imgProps) => {
    return(
        <div className="relative lg:h-120 2xl:h-120 h-80 2xl:w-110 flex-col gap-5 lg:w-95 w-85 flex justify-center items-center overflow-hidden">
            ...
            <img src={props.titleSrc} className="absolute 2xl:h-7 lg:h-7 h-7 lg:top-20 top-12"/>
            <img src={props.descSrc} className="absolute 2xl:h-22 lg:h-22 h-18 lg:top-35 top-25"/>
