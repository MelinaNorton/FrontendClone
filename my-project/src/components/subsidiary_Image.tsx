...
const SubsidiaryImage:React.FC<imgProps> = (props : imgProps) => {
    return(
        <div className="rounded-md relative lg:h-130 2xl:h-130 h-80 2xl:w-110 flex-col gap-5 lg:w-95 w-85 flex justify-center items-center overflow-hidden hover:cursor-pointer">
            ...
            <p className="absolute text-xs font-bold text-white 2xl:bottom-10 lg:bottom-20 bottom-3">{props.lm}</p>
        </div>
    );
}
