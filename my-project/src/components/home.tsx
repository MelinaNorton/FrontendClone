    ...
    return (
      ...
      <div className="absolute flex-col inset-0 flex justify-center items-center lg:gap-5 2xl:gap-28 gap-10 lg:pt-5 2xl:pt-80 pt-60">
            <div className="width:100% lg:w-29/30 2xl:w-7xl w-100 px-4">
              <h1 className="font-sans tracking-wider text-white font-semibold lg:text-5xl text-3xl 2xl:text-5xl text-left mt-20 sm:mt-40 pb-3 lg:pt-50 2xl:pt-80">Empowering brands through CX and digital transformation excellence</h1>
