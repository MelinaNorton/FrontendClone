...
const HomeSection = () => {
    return (
      ...
      <div className="z-30 flex-col inset-0 flex justify-center items-center border border-red-500">
        ...
        <div className="flex flex-row items-start justify-between lg:gap-200 2xl:gap-740 w-screen p-4 z-20 border border-blue-500">
