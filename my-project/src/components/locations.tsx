...
const LocationPic:React.FC<locationsProps> = (props : locationsProps) =>{
    return(
        <div className="relative lg:h-94 h-85 2xl:h-150 2xl:w-180 lg:w-160 md:w-160 w-120">
            <img src={props.bgSrc} className="flex rounded-xl lg:h-94 md:h-65 h-55 2xl:h-150 2xl:w-300 lg:w-200 md:w-300 w-60"></img>
