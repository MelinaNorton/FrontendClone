...
export const TextInputSchema = yup.object({
    ...
    level : yup.string().required("level is required").max(20),
    location: yup.string().required("location preference is required").max(20),
    diaspora: yup.string().required("diaspora status is required").max(20),
    ...
    phonenum: yup.string().required("phone number is required").max(20),
